...
<div class="DbScheme" >
    ...
    <div class="page-wrapper" style="display: block; border:0px red solid;
                                     margin:2px; background: url('/assets/img/page-grid.jpg') !important;
            ...
            <div class="d-flex align-items-center">
              <nav><ul class="main-nav-ul" style="display: flex !important;">
                <template v-for="(title, fname) in panelSettingsMenu" >
                  <li  v-if="fname != 'sql_editor' && fname != 'db_settings' " :key="fname"
      ...
      <div class="container-fluid" style="margin:2px; padding:2px;" >
          <div @mousemove="dragMove($event)" class="canvas-container" style="" >
                            ...
                            <table class="tableFieldsBox">
                              <tr v-for="(field, fname) in item.fields">
                                ...
                                <td style="background: red; width: 30px; text-align: center">
                                  <i @click="deleteTableField(item.name, fname, i)"
                                      class="fa fa-times" style="color:white;font-size: 14px; cursor:pointer"></i>
                                </td>
                              </tr>
                            </table>
